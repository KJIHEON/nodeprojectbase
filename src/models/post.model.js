  ...
  const post = sequelize.define(
    ...
    /* Properties */
    {
      ...
      comment: {
        ...
        defaultValue: DataTypes.UUIDV4, //다폴트로 랜덤 스트링 값
        /* true null 허용 */
        notNull: true,
        /* commnent 쿼리문 조회 */
        comment: '',
      ...
      reg_date: {
        ...
        defaultValue: sequelize.literal('UNIX_TIMESTAMP()'), //유닉스 타입으로 숫자로 사용
        notNull: false,
        comment: '',
      },
    },
    /* options */
    {
      ...
      //       rec.dataValues.reg_date = moment().format('YYYY-MM-DD HH:mm:ss'); //날짜 포멧
      //     },
      /* 생성전이나 생성후 함수 실행 할 때
